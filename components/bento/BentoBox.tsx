        ...
        >
            ...
            >
                <div className="relative flex h-full w-full items-center justify-center rounded-lg">
                    ...
                    />
                    <ExternalLink href="https://github.com/psga" />
                </div>
            </div>
            <div key="image-1">
                <Image
            ...
            >
                <div className="relative flex h-full w-full items-center justify-center rounded-lg">
                    ...
                    <SilhouetteHover
                        ...
                        className="rounded-3xl object-cover"
                    />
                    <ExternalLink href="https://twitter.com/pablousu" />
                </div>
            </div>
            <div
                key="spotify"
            ...
            >
                <SilhouetteHover
                    silhouetteSrc="/static/images/bento/bento-technologies-silhouette.svg"
                    silhouetteAlt="Bento Tech Silhouette"
                    mainSrc="/static/images/bento/bento-technologies.svg"
                    mainAlt="Bento tech"
                    className="rounded-3xl object-cover"
                />

                <ExternalLink href="https://psga.github.io/pusu/" />
            </div>
            <div
                key="contributions"
